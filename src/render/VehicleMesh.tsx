  ...
  return (
    <>
      ...
      */}
      ...
      {/*
        Прицеп темнее и светится вполсилы — под порогом блума. Разница в тоне
        нужна не ради разнообразия: два одинаково ярких бруска на общем плане
        сливаются в оранжевое пятно, а тёмный прицеп за яркой кабиной сразу
        читается как направление движения. Оба цвета из палитры, замок цел.
      */}
      <instancedMesh
        ref={trailerRef}
        args={[undefined, undefined, capacity]}
